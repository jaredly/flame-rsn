...
var $$Array     = __webpack_require__(8);
var Curry       = __webpack_require__(3);
var Flame       = __webpack_require__(63);
var MyDom       = __webpack_require__(37);
var Js_json     = __webpack_require__(10);
var Js_boolean  = __webpack_require__(11);
var Pervasives  = __webpack_require__(5);
var WorkerTypes = __webpack_require__(62);
...
var Caml_int64              = __webpack_require__(40);
var Caml_utils              = __webpack_require__(41);
var Caml_builtin_exceptions = __webpack_require__(4);
...
function createCtx(container, width, height) {
...
var Caml_obj                 = __webpack_require__(14);
var Caml_sys                 = __webpack_require__(34);
var Caml_format              = __webpack_require__(30);
...
var Caml_builtin_exceptions  = __webpack_require__(4);
var CamlinternalFormatBasics = __webpack_require__(57);
...
function renderToData(data, size, mx, max) {
  var buff = data.data;
  var fmax = max;
  for(var x = 0 ,x_finish = size - 1 | 0; x <= x_finish; ++x){
    for(var y = 0 ,y_finish = size - 1 | 0; y <= y_finish; ++y){
      var n = Caml_array.caml_array_get(mx, Caml_int32.imul(x, size) + y | 0);
      var o = ((Caml_int32.imul(y, size) + x | 0) << 2);
      if (n > 0) {
        var alpha = Math.log(n) / Math.log(fmax);
        Caml_array.caml_array_set(buff, o, alpha * 255 | 0);
        Caml_array.caml_array_set(buff, o + 1 | 0, alpha * 40 | 0);
        Caml_array.caml_array_set(buff, o + 2 | 0, alpha * 160 | 0);
        Caml_array.caml_array_set(buff, o + 3 | 0, 255);
      } else {
        Caml_array.caml_array_set(buff, o + 3 | 0, 255);
      }
    }
...
var Curry                   = __webpack_require__(3);
var Js_exn                  = __webpack_require__(58);
var Caml_array              = __webpack_require__(15);
var Caml_exceptions         = __webpack_require__(24);
var Caml_builtin_exceptions = __webpack_require__(4);
